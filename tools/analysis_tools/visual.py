...
if __name__ == '__main__':
    ...
    bevformer_results = mmcv.load('test/bevformer_base/Wed_Mar_26_00_51_20_2025/pts_bbox/results_nusc.json')
    sample_token_list = list(bevformer_results['results'].keys())
    for id in range(0, 6008):
        render_sample_data(sample_token_list[id], pred_data=bevformer_results, out_path='test/bevformer_base/vis/' + sample_token_list[id])
